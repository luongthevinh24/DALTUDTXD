...
namespace _67TH3_LTUDTXD_HUCE_20_DuongThiDuyen_0257867_67TH3.ViewModels
{
    public class DamChuNhatViewModel : INotifyPropertyChanged
    {
        ...
        private void ExecuteTinhToan(object parameter)
        {
            ...
            if (B > 0 && H > 0)
            {
                ...
                if (am < Ar)
                {
                    ...
                    if (U < Umax && U > 0.1)
                    {
                        ...
                        StringBuilder message = new StringBuilder("Các tổ hợp tốt nhất:\n");
                        foreach (var pair in bestPairs)
                        {
                            ...
                            message.AppendLine($"{combo}, Tổng diện tích: {pair.tongTich}, Số thanh: {pair.soThanh}.");
                        }
            ...
            {
                MessageBox.Show("Nhập Kích Thước Dầm");
                KetQua = string.Empty;
            }
        }
